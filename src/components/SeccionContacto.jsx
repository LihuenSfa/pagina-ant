...
const SeccionContacto = () => {
    return (
        <section className="relative h-screen min-[320px]:h-screen w-full overflow-hidden">
            <img src={imgCam} alt="" className='absolute inset-0 h-full w-full object-cover fondo'/>
            <div className="relative z-10 flex h-full min-[320px]:h-screen w-full flex-col items-center justify-center bg-black bg-opacity-50">
                <h1 className="mb-4 text-3xl md:text-7xl ">Déjenos un mensaje</h1>
